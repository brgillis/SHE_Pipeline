...
CMD="E-Run SHE_CTE 0.3 SHE_CTE_CrossValidateShear --shear_estimates_product $SE_PROD --cross_validated_shear_estimates_product $CVSE_PROD --workdir $WORKDIR --logdir $LOGDIR"

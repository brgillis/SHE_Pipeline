""" @file meta_bias_measurement.py
    ...
    Pipeline script for the shear bias calibration pipeline.
"""
...
def meta_shear_bias_residual_measurement(pickled_args):

    pipeline_output = she_run_bias_calibration_pipeline(pickled_args=pickled_args)
...
if __name__ == '__main__':
    ...
    pydron_graph = build_graph(meta_shear_bias_residual_measurement)

...
ARCHIVE_DIR="/ceph/cam/memTest/sens_archive2mb"
WORKSPACE_ROOT="/ceph/cam/memTest/sens2mb_workdirs/sens_"
LOGDIR="/ceph/cam/memTest/sens2mb_logs"
...
KILLFILE="DELETE_ME_TO_STOP_MEMTEST2MB_SCRIPT"
